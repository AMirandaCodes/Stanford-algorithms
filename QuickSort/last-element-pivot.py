...
def quicksort(array, low=0, high=None):
    ...
    if low < high:
        ...
        # Swaps first with last (Stanford's assignment requirement)
        # Makes pivot last element whilst maintaining same partition function 
...
if __name__ == "__main__":
    ...
    print("Total comparisons (via Quicksort, last element as pivot):" , comparisons)